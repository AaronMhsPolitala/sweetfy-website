...
export const BRAND_DATA = {
  ...
  subtagline: "Es Kulkul, Es Teh, dan Jus Buah Sweetify, teman manis dan segar untuk menemani setiap momen kamu.",
  whatsappNumber: "6283119465702",
  whatsappUrl: "https://wa.me/6283119465702",
  locationName: "Sweetify Base",
  locationAddress: "Parkiran Belakang Kantin Politeknik Negeri Tanah Laut",
  googleMapsUrl: "https://maps.app.goo.gl/CMNBQCSodQUNQahP6",
  email: "hello@sweetify.com",
  phone: "+62 831-1946-5702",
  operatingHours: "Jam 08:00 - 16:00 WITA",
  operatingDays: "1 - 2 September",
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: "Rp10,000",
    numericPrice: 10000,
    description: "Jus buah murni segar pilihan (Alpukat & Mangga) yang kental, manis alami, kaya vitamin, dan siap membakar semangat seharian.",
    image: "/images/JusBuah.jpeg",
    alt: "Jus Buah Alpukat dan Mangga segar nan dingin",
    containerBg: "bg-tertiary-container/30",
    category: "Jus Buah",
  },
];
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    id: "t2",
    quote: "Es Teh dan Jus Buahnya andalan tiap abis kelas siang. Nyegerin banget dan manisnya gak bikin eneg. Sering-sering buka bazar dong!",
    author: "Dimas A.",
